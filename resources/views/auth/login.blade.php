...
">
                <img width="135px" src="<?php echo asset('quickadmin/images/logo_white_title.png') ?>">
            </div>
            <div class="panel panel-default" style="border-color:#b43635 ">

                <div class="panel-heading" style="background-image: linear-gradient(to right, #b33535 0%, #ff7f2a 100%); color: white">Time2Staff Admin Login</div>
