                ...
                <div class="contact-info login_box">
                    <div class="contact-form loginWrp registerWrp">
                            ...
                            <div class="form-group row">
                                <label for="fullname" class=" col-sm-3 col-form-label {{ $errors->has('full_name') ? 'text-danger' : '' }} ">Full Name :</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="dob" class=" col-sm-3 col-form-label {{ $errors->has('dob') ? 'text-danger' : '' }}">Date of Birth :
                            ...
                            <div class="form-group row">
                                <label for="gender" class="col-sm-3 col-form-label align-start {{ $errors->has('gender') ? 'text-danger' : '' }}">Gender :
                                </label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                                <label for="category" class=" col-sm-3 col-form-label {{ $errors->has('category') ? 'text-danger' : '' }}">Category:</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="aadhar" class=" col-sm-3 col-form-label  {{ $errors->has('aadhar') ? 'text-danger' : '' }}">Aadhaar No:
                            ...
                            <div class="form-group row">
                                <label for="contact" class="col-sm-3 col-form-label {{ $errors->has('contact_no') ? 'text-danger' : '' }}">Contact No.:</label>
                                <div class="col-sm-3">
                                ...
                                <label for="whatsapp" class="col-sm-2 col-form-label {{ $errors->has('whatsapp_no') ? 'text-danger' : '' }}">Whatsapp No.:</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                                <label for="lastschool" class="col-sm-3 col-form-label {{ $errors->has('last_school') ? 'text-danger' : '' }}">Last School Attended:</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="hslc_result" class="col-sm-3 col-form-label {{ $errors->has('hslc_result') ? 'text-danger' : '' }}">Result of HSLC Exam:
                            ...
                            <div class="form-group row">
                                <label for="father" class="col-sm-3 col-form-label {{ $errors->has('father_name') ? 'text-danger' : '' }}">Father's name:</label>
                                <div class="col-sm-3">
                                ...
                                <label for="father_occupation" class="col-sm-2 col-form-label {{ $errors->has('father_occupation') ? 'text-danger' : '' }}">Occupation:</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                                <label for="mother" class=" col-sm-3 col-form-label {{ $errors->has('mother_name') ? 'text-danger' : '' }}">Mother's name:</label>
                                <div class="col-sm-3">
                                ...
                                <label for="mother_occupation" class=" col-sm-2 col-form-label {{ $errors->has('mother_occupation') ? 'text-danger' : '' }}">Occupation:</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                                <label for="present_address" class="col-sm-3 col-form-label {{ $errors->has('present_address') ? 'text-danger' : '' }}">Present Address:</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="permanent_address" class="col-sm-3 col-form-label {{ $errors->has('permanent_address') ? 'text-danger' : '' }}">Permanent Address:</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="town" class=" col-sm-3 col-form-label {{ $errors->has('village_town') ? 'text-danger' : '' }}">Village/Town:</label>
                                <div class="col-sm-3">
                                ...
                                <label for="district" class="col-sm-2 col-form-label {{ $errors->has('district') ? 'text-danger' : '' }}">District:</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                                <label for="state" class="col-sm-3 col-form-label {{ $errors->has('state') ? 'text-danger' : '' }}">State:</label>
                                <div class="col-sm-3">
                                ...
                                <label for="pin" class="col-sm-2 col-form-label {{ $errors->has('pin') ? 'text-danger' : '' }}">Pin Code:</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                                <label for="email" class=" col-sm-3 col-form-label {{ $errors->has('email') ? 'text-danger' : '' }}">Email:</label>
                                <div class="col-sm-8">
