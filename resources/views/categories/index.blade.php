            ...
            <div class="table-responsive">
                <div class="card">
                    <div class="card-header">
                     <div class="card-title pull-left">Categories</div>
                        <a href="{{ route('categories.category.create') }}">
                    ...
                    <div class="card-body">
                <table class="table table-striped full-width" id="datatable-categories">
                    <thead>
                        <tr>
                            <th>Title</th>
                            <th>Published</th>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        ...
                                        <button type="submit" class="btn btn-danger btn-sm" title="Delete Category" onclick="return confirm(&quot;Delete Category?&quot;)">
