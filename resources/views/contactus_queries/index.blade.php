            ...
            <div class="table-responsive">
                <div class="card">
                    <div class="card-header">
                     <div class="card-title pull-left">Contactus Queries</div>
                        <a href="{{ route('contactus_queries.contactus_query.create') }}">
                    ...
                    <div class="card-body">
                <table class="table table-striped full-width" id="datatable-contactusQueries">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Email</th>
                    ...
                    <tbody>
                    @if(count($contactusQueries))
                    @foreach($contactusQueries as $contactusQuery)
                        <tr>
                            <td>{{ $contactusQuery->name }}</td>
                            <td>{{ $contactusQuery->email }}</td>
                            <td>{{ $contactusQuery->phone }}</td>
                            <td>{{ $contactusQuery->subject }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('contactus_queries.contactus_query.show', $contactusQuery->id ) }}" class="btn btn-info  btn-sm" title="Show Contactus Query">
                                            <span class="fa fa-eye" aria-hidden="true"></span>
                                        </a>
                                        <a href="{{ route('contactus_queries.contactus_query.edit', $contactusQuery->id ) }}" class="btn btn-primary  btn-sm" title="Edit Contactus Query">
                                            <span class="fa fa-pencil" aria-hidden="true"></span>
                                        </a>

                                        <button type="submit" class="btn btn-danger btn-sm" title="Delete Contactus Query" onclick="return confirm(&quot;Delete Contactus Query?&quot;)">
...
<script>
    ...
    $('#datatable-contactusQueries').DataTable({
