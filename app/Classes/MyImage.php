...
class MyImage {
    ...
    public $image, $filename, $original_info, $width, $height, $mime;
    ...
    //
	public function load($filename, $info = null) {
	...
	public function save($filename = null, $quality = null) {
        ...
        switch (strtolower($format)) {
            ...
            case 'gif':
                ...
                do {
                    $imagick->resizeImage($this->width, $this->height, Imagick::FILTER_BOX, 1);
                } while ($imagick->nextImage());
                $imagick = $imagick->deconstructImages();
                $result = $imagick->writeImages($filename, true);
                break;
            ...
            case 'png':
                ...
                $result = imagepng($this->image, $filename, 0);
                break;
	...
	public function overlay($overlay_file, $position = 'center', $opacity = 1, $x_offset = 0, $y_offset = 0) {
        ...
        // Load overlay image
        $overlay = new MyImage($overlay_file);
    ...
    public function backgroundFill($color){
        ...
        $white = imagecolorallocate($base_image, $color['r'], $color['g'], $color['b']);
        imagefill($base_image, 0, 0, $white);

        $top_image = $this->image;
